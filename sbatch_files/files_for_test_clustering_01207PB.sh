...
SMR_FILE=../results/test/summary_stats_clustering_01207PB.csv

count=0

for f in $(ls ../results/test/stats_clustering_01207PB_clone_*txt)
do
	...
	RDM_FILE=../results/test/stats_clustering_01207PB_${CLONE_ID}_rdm.csv
