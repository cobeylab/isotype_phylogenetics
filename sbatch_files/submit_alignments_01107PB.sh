...
ls ../results/clones/01107PB_clone_* | grep -v 'macse' | grep -o 'clone_[0-9]*'|tr -d [a-z_] > clone_ids_01107PB.tmp
...
do
    ...
    do
      ...
      NUMSEQ=$(grep '>' ../results/clones/01107PB_clone_${ID}.fasta | wc -l)
    ...
    sbatch --array=$RETAINED_IDS run_MACSE_01107PB.sbatch       
    
done

# Remove temporary files
rm clone_ids_01107PB*