...
SMR_FILE=../results/test_clustering/summary_stats_clustering_SFAPB.csv

count=0

for f in $(ls ../results/test_clustering/stats_clustering_SFAPB_clone_*txt)
do
	...
	RDM_FILE=../results/test_clustering/stats_clustering_SFAPB_${CLONE_ID}_rdm.csv
